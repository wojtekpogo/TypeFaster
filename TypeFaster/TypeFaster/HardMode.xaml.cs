...
namespace TypeFaster
{
	...
	public partial class HardMode : ContentPage
	{
        ...
        String[] hardRandomWords = new String[] { "RandOMiZe", "maNagEmeNt", "eNthUsiaSm", "aRrangEment", "soFTWarE", "XaMaRiN", "asseSSment", "aCquaintaNce", "shUftisc0pe", "wondeRmonger", "torulose", "repreSentaTionaLism","eXtrateRrestrial","InapPropriate","constitUtional","consciouSneSs"};
        public HardMode ()
		{
            timer = new Timer
            {
            ...
            rnd.Next(hardRandomWords.Length);

            // displays random words
            lbl.Text = hardRandomWords[rnd.Next(hardRandomWords.Length)];
        }
